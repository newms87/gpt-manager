...
--
-- Name: tortguard__object_attributes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tortguard__object_attributes (
    id bigint NOT NULL,
    object_id bigint,
    name text,
    date timestamp with time zone,
...
--
-- Name: tortguard__object_attributes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tortguard__object_attributes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tortguard__object_attributes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tortguard__object_attributes_id_seq OWNED BY public.tortguard__object_attributes.id;


--
-- Name: tortguard__object_relationships; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tortguard__object_relationships (
    id bigint NOT NULL,
    relationship_name text,
    object_id bigint,
    related_object_id bigint,
...
--
-- Name: tortguard__object_relationships_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tortguard__object_relationships_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tortguard__object_relationships_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tortguard__object_relationships_id_seq OWNED BY public.tortguard__object_relationships.id;


--
-- Name: tortguard__objects; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tortguard__objects (
    id bigint NOT NULL,
    ref text,
    type text,
    name text,
...
--
-- Name: tortguard__objects_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tortguard__objects_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tortguard__objects_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tortguard__objects_id_seq OWNED BY public.tortguard__objects.id;
...
--
-- Name: tortguard__object_attributes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tortguard__object_attributes ALTER COLUMN id SET DEFAULT nextval('public.tortguard__object_attributes_id_seq'::regclass);


--
-- Name: tortguard__object_relationships id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tortguard__object_relationships ALTER COLUMN id SET DEFAULT nextval('public.tortguard__object_relationships_id_seq'::regclass);


--
-- Name: tortguard__objects id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tortguard__objects ALTER COLUMN id SET DEFAULT nextval('public.tortguard__objects_id_seq'::regclass);
...
--
-- Name: audit_request idx_27734_primary; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.audit_request
    ADD CONSTRAINT idx_27734_primary PRIMARY KEY (id);
...
--
-- Name: tortguard__object_attributes idx_28064_primary; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tortguard__object_attributes
    ADD CONSTRAINT idx_28064_primary PRIMARY KEY (id);


--
-- Name: tortguard__object_relationships idx_28071_primary; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tortguard__object_relationships
    ADD CONSTRAINT idx_28071_primary PRIMARY KEY (id);


--
-- Name: tortguard__objects idx_28076_primary; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tortguard__objects
    ADD CONSTRAINT idx_28076_primary PRIMARY KEY (id);
...
--
-- Name: idx_28064_fk_tortguard__object_attributes_message_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_28064_fk_tortguard__object_attributes_message_id ON public.tortguard__object_attributes USING btree (message_id);


--
-- Name: idx_28064_fk_tortguard__object_attributes_source_stored_file_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_28064_fk_tortguard__object_attributes_source_stored_file_id ON public.tortguard__object_attributes USING btree (source_stored_file_id);


--
-- Name: idx_28064_fk_tortguard__object_attributes_thread_run_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_28064_fk_tortguard__object_attributes_thread_run_id ON public.tortguard__object_attributes USING btree (thread_run_id);


--
-- Name: idx_28064_unique_object_attribute_name_field; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_28064_unique_object_attribute_name_field ON public.tortguard__object_attributes USING btree (object_id, name, date);


--
-- Name: idx_28071_fk_tortguard__object_relationships_related_object_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_28071_fk_tortguard__object_relationships_related_object_id ON public.tortguard__object_relationships USING btree (related_object_id);


--
-- Name: idx_28071_unique_related_object_field; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_28071_unique_related_object_field ON public.tortguard__object_relationships USING btree (object_id, related_object_id);


--
-- Name: idx_28076_unique_object_type_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_28076_unique_object_type_name ON public.tortguard__objects USING btree (type, name);


--
-- Name: idx_28076_unique_object_type_ref; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_28076_unique_object_type_ref ON public.tortguard__objects USING btree (type, ref);
...
SELECT pg_catalog.setval('public.migrations_id_seq', 153, true);
