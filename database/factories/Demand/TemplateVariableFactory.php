...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Demand\TemplateVariable>
 */
class TemplateVariableFactory extends Factory
{
    ...
    /**
     * Set the variable to be for a specific demand template.
     */
    public function forTemplate(DemandTemplate $template): static
    {
        return $this->state(fn(array $attributes) => [
