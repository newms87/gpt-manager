...
<script setup>
import DrugIssueCard from "@/components/Modules/Tortguard/DrugIssueCard";
...
const drugIssue = {
		...
		"drug": {
			...
			"statute_of_limitations_tolling": "5 years"
		},
		"issue": {
			"id": 1,
		...
		"data_sources": [
			{
				...
				"table": "drugs",
				"field": "warnings",
				"explanation": "FDA warnings about drugs."
			},
			{
				"id": 200,
				"name": "Patent Watch",
				"url": "https://www.drugpatentwatch.com/blog/viagra-a-complicated-case-study-of-generic-drug-market-entry-in-the-united-states/",
				"table": "drugs",
				"field": "patent_number",
				"explanation": ""
			},
			...
			{
				"id": 3,
				"name": "DrugPatentWatch - Make Better Decisions",
				"url": "https://www.drugpatentwatch.com/blog/viagra-a-complicated-case-study-of-generic-drug-market-entry-in-the-united-states/",
				"table": "drugs",
				"field": "patent_details",
				"explanation": ""
			},
			{
				"id": 4,
				"name": "Casetext - CoCounsel",
				"url": "https://casetext.com/case/pfizer-inc-v-teva-pharmas-usa-inc",
				"table": "drugs",
				"field": "patent_details",
				"explanation": ""
			},
			{
				"id": 5,
				"name": "Wikipedia",
				"url": "https://en.wikipedia.org/wiki/Sildenafil",
				"table": "drugs",
				"field": "patent_details",
				"explanation": ""
			},
			{
				"id": 6,
				"name": "Single Care",
				"url": "https://www.singlecare.com/blog/news/erectile-dysfunction-statistics/",
				"table": "drugs",
				"field": "number_of_users",
				"explanation": "Approximately 30 million men in the United States use Viagra (sildenafil) to treat erectile dysfunction."
			},
			{
				"id": 7,
				"name": "Drugs.com",
				"url": "https://www.drugs.com/article/viagra-little-blue-pill.html",
				"table": "drugs",
				"field": "number_of_users",
				"explanation": "his medication has become one of the most popular treatments for ED since its introduction, providing significant benefits for many men experiencing this condition"
			},
			{
				"id": 8,
				"name": "Investors Pfizer",
				"url": "https://investors.pfizer.com/financials/annual-reports/default.aspx",
				"table": "companies",
			...
			{
				"id": 13,
				"name": "Mordor Insights",
				"url": "https://www.mordorintelligence.com/industry-reports/erectile-dysfunction-drugs-market",
				"table": "drugs",
				"field": "market_share",
				"explanation": ""
			},
