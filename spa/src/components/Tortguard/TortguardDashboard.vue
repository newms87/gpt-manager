<template>
	<div class="relative h-full">
		<div v-if="!drugSideEffects.length" class="text-center text-gray-400 text-xl py-10">
			Currently there are no active research projects. Ask the AI below to find you some!
		</div>
