...
import { Connection, ConnectionMode, Edge, EdgeProps, Node, VueFlow } from "@vue-flow/core";
import "@vue-flow/core/dist/style.css";
import "@vue-flow/core/dist/theme-default.css";
import { onMounted, ref, watch } from "vue";
import WorkflowCanvasNode from "./WorkflowCanvasNode.vue";

const uniqId = ref(`workflow-canvas-${Math.random().toString(36).substring(2, 15)}`);
