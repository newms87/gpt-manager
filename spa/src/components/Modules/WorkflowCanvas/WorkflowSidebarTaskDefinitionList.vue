...
const createTaskAction = dxTaskDefinition.getAction("create-with-name");
const deleteTaskAction = dxTaskDefinition.getAction("delete-with-confirm", { onFinish: async () => emit("refresh") || await loadTaskDefinitions() });
