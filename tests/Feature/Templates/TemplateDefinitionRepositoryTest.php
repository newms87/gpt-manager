...
class TemplateDefinitionRepositoryTest extends AuthenticatedTestCase
{
    use SetUpTeamTrait;

    protected TemplateDefinitionRepository $repository;
    ...
    public function setUp(): void
    {
        parent::setUp();
        $this->setUpTeam();
        $this->repository        = app(TemplateDefinitionRepository::class);
    ...
    public function test_model_delete_deletesTemplate(): void
    {
        ...
        $this->assertSoftDeleted('template_definitions', ['id' => $template->id]);
    }
